...
public class Player {
  ...
  private @Nullable Integer hearts;

  private @Nullable Integer tokens;

  public Player id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Player name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Player hearts(@Nullable Integer hearts) {
    this.hearts = hearts;
    return this;
  }
  ...
  @Schema(name = "hearts", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("hearts")
  public @Nullable Integer getHearts() {
    return hearts;
  }

  @JsonProperty("hearts")
  public void setHearts(@Nullable Integer hearts) {
    this.hearts = hearts;
  }

  public Player tokens(@Nullable Integer tokens) {
    this.tokens = tokens;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, player.id) &&
        ...
        Objects.equals(this.hearts, player.hearts) &&
        Objects.equals(this.tokens, player.tokens);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, hearts, tokens);
  }
