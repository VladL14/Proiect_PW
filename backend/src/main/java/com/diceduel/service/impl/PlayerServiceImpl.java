...
public class PlayerServiceImpl implements PlayerService {
    ...
    public void uploadAvatar(String playerId, MultipartFile file) {
        ...
        try {
            player.setAvatarData(file.getBytes());
    ...
    public void deleteAvatar(String playerId) {
        ...
        player.setAvatarData(null);
        playerRepository.save(player);
    }
    @Override
public void setAvatarStyle(String playerId, String avatarStyle) {
    PlayerEntity player = findPlayerEntity(playerId);
    player.setAvatarData(null);
    player.setAvatarFileName(null);
    player.setAvatarContentType(null);
    player.setAvatarStyle(avatarStyle);
    playerRepository.save(player);
}
    @Override
    @Transactional(readOnly = true)
    public byte[] getAvatarData(String playerId) {
        PlayerEntity player = findPlayerEntity(playerId);
        return player.getAvatarData();
    }
