...
public interface PlayerService {
    ...
    /**
     * Stores avatar metadata and binary data for the selected player.
     *
     * @param playerId player identifier
    ...
    /**
     * Retrieves the raw binary data of the player's avatar.
     *
     * @param playerId player identifier
     * @return avatar bytes, or null if no avatar is stored
     */
    byte[] getAvatarData(String playerId);
    ...
    void setAvatarStyle(String playerId, String avatarStyle);
}
